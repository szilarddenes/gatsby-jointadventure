...
import OpenLink from 'assets/scg/OpenLink.svg'
...
export default function BlogPost({data}) {
  ...
  const WebsiteLink =data.markdownRemark.frontmatter.website
        ...
        <PostMeta>
          <StackStyle>
            ...
            <TagStyle>
             ...
             <a href={WebsiteLink}target="_blank"> <OpenLink style={{width:"1rem"}}/> </a>
          </StackStyle>
          <br />
