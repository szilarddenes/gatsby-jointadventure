  ...
  return (
    <>
      ...
      <Layout>
        ...
        <Image fluid={data.RandomPhoto.childImageSharp.fluid } style={{width:756}} />
        <TextBody>
          ...
          - contact us, we are human as you do
        </TextBody>
...
export const data = graphql`
  query {
    RandomPhoto: file(relativePath: {eq: "assets/images/AboutU.png"}) {
      childImageSharp {
        fluid(maxWidth: 756) {
