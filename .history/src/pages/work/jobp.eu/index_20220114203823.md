...
The portal is <c>user oriented</c>. Both, the applicants and employers can register, and handle their subscription, job posts or job applications using the dashboard. In case of a job application the applicant can attach his resume which gets uploaded to the JobP <c>database<> and emailed to the employer. The non authenticated users can apply on jobs as well via e-mail or <c>WhatsApp</c>.   
