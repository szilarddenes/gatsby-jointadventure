...
Regarding the fronted features, the biggest improvement was implementing a leaflet map, which shows the job posts by location, and with a popup marker a job application is available also. Besides this, several search and filter options
