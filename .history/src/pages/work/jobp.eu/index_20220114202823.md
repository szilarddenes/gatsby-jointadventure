...
The JobP.eu is a Wordpress based job portal, where a basic template was reworked and upgraded to satisfy our needs. Both the users, both, employees and employers can register on the site, and handle their job posts or applications. The non authenticated users can apply on jobs as well.   
