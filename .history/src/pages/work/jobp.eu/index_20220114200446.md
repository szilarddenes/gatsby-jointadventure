...
Each user id able to handle its job applications/resumes or job posts using the dashboard. In case of a job application the applicant can attach his resume which gets uploaded to the JobP database an
