...
Regarding the fronted features, the biggest improvement was implementing a <c>leaflet map</c>, which shows the job posts by location, and with a popup marker the application on jobs is alsoavailable. Besides this, several search and filter options are available to browse the job posts.  
