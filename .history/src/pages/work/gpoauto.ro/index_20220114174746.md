...
This static site, sits on a shared host, which is in a direct communication with the projects's github repository. The site, obviously is speed oriented, and it is using the latest available technologies to work 
