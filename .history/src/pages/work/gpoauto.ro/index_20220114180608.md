...
To achieve the requirements of our client, we've used and welded together several technologies. For fronted, we've used the blazing fast <c>Gatsby</c> static site generator, which is a <c>React JS based framework. 
