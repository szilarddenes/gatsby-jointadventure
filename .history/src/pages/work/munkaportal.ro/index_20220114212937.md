...
Even so, quite a few features was built in, like the 11in house translation plugin22, which delivers the content on 4 languages.  
 ...
 Besides this and the 11responsive slider22,  the brightest feature is the job post 11form22, which isn't using any plugins or frameworks for form validation, but it handles with pure javascript. The form gets submitted to 11google sheets22, which sends automatic notification to our admins.  

 All this done in pure 11javascript22. Simply and fast.
