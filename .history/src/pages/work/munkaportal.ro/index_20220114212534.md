...
Even so, quite a few features was built in, like the in house translation plugin, which delivers the content on 4 languages.  
 ...
 Besides the responsive slider,  the brightest feature is the job post form, which isn't using any plugins or frameworks for form validation, but it handles with pure javascript. The form gets submitted to a google sheet, which notifies sends automatic notification to our admins. All this done in pure javascript.
