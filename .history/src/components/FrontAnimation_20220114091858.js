...
const Animation = styled.div`
  ...
  .container .loader {
    ...
    width: 200px;
    height: 150px;
    background-image:url("data:image/svg+xml;<svg fill="none" viewBox="0 0 1020 1024" xmlns="http://www.w3.org/2000/svg"><path d="m1010.1 512c0 277.84-224.14 503-500.54 503-276.4 0-500.54-225.16-500.54-503s224.14-503 500.54-503c276.4 0 500.54 225.16 500.54 503z" fill="#0FB" stroke="#000" stroke-width="18"/></svg>";
