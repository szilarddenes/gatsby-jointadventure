...
const animationBackground=graphData.childImageSharp.fluid.src
...
.container .loader {
    ...
    width: 200px;
    height: 150px;
       background: url("${animationBckg}") no-repeat 55%/60%;
}
...
export const graphData =graphql`
query Images {
  exampleImage: file(extension: {eq: "png"}, name: {eq: "JAIconNarrow"}) {
    childImageSharp {
      fluid {
        src
        srcSet
