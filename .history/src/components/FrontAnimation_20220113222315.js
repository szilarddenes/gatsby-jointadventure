...
// const animationBackground=graphData.bcgImg.childImageSharp.fluid
...
.container .loader {
    ...
    width: 200px;
    height: 150px;
       background: url("${data.bcgImg.childImageSharp.fluid}") no-repeat 55%/60%;
}
...
export default function FrontAnimation(data) {
  return (
    <>
      <Animation>
